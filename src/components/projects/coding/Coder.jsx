...
import "./coding.css";
import TDR from "./previews/fidgets.png";
import YARNIA from "./previews/yarnia.png";
import PORTFOLIO from "./previews/portfolio.png";
...
const projects = [
  ...
  },
  {
    ...
    demoLink: "https://yarnia.netlify.app/",
  ...
  return (
    <div
      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        <button className="modalX" onClick={onClose} aria-label="Close modal">
          <CloseXIcon />
        </button>
        <div className="modalMedia" style={{ backgroundImage: `url(${project.image})` }}></div>
